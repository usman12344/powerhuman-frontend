    ...
    <div class="lg:pr-[70px] py-[50px] lg:ml-[320px] xl:ml-[365px] px-4 lg:pl-0">
        ...
        <section class="pt-[50px]">
            ...
            <div class="mb-[30px]">
                <div class="flex flex-col justify-between gap-6 sm:items-center sm:flex-row">
                    ...
                    <NuxtLink :to="{ name:'companies-id-employee-create' }" class="btn btn-primary">Add Employee</NuxtLink>
                </div>
            </div>
                ...
                <div class="card !gap-y-10">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <div class="text-[32px] font-bold text-dark mt-[6px]" v-for="employee in employees.data" :key="employee.id">
        ...
        <section class="pt-[50px]">
            ...
            <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4 xl:gap-10 lg:gap-3">
                ...
                <p v-if="$fetchState.pending">Fetching name...</p>
                <!-- Card -->
                <div v-else class="items-center card py-6 md:!py-10 md:!px-[38px] !gap-y-0" v-for="employee in employees.data.data.data" :key="employee.id">
                    ...
                    <img :src="employee.photo" width="70" alt="rounded-full">
...
export default {
    ...
    async fetch() {
    //   this.employees = await this.$axios.$get('/team?company_id=' + this.$route.params.id + '&limit=100') or
