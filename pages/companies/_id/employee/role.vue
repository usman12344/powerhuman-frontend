   ...
   <section class="py-[70px] flex flex-col items-center justify-center px-4">
        ...
        <form class="w-full card">
            ...
            <div class="form-group">
                ...
                :value="role_id" @change="updateRoleId"
                >
            ...
            <section>
                ...
                <div class="flex flex-col gap-4 mt-[10px]">
                    <div class="flex items-start md:items-center gap-[6px]" v-for="responsibility in rosponsibilities" :key="responsibility.id">
            ...
            <NuxtLink :to="{ name: 'companies-id-employee-team' }" class="w-full btn btn-primary mt-[14px]">
                Continue
            </NuxtLink>
        </form>
    </section>
    ...
    methods: {
        fetchResponsibilities() {
            this.$axios.get('/responsibility', {
                ...
                .then(({ data }) => {
                    this.rosponsibilities = data.data.data
                })
        },
        updateRoleId(event) {
