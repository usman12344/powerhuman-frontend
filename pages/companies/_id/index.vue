                ...
                <div class="card !gap-y-10 min-h-[200px]">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <div class="text-[32px] font-bold text-dark mt-[6px]" v-for="(employee, index) in employees.data" :key="index">
                                {{ employee.total }}
                            </div>
                        </div>
                        <NuxtLink :to="{ name: 'companies-id-employee-create' }">
                ...
                <div class="card !gap-y-10 min-h-[200px]">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <div class="text-[32px] font-bold text-dark mt-[6px]" v-for="(team, index) in teams.data" :key="index">
                                {{ team.total }}
                            </div>
                        </div>
